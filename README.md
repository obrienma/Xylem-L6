...
| [ADR 0008](docs/adr/0008-synapse-l4-payload-mapping.md) | Synapse-L4 payload contract: `source_id`/`status`/`metric_value`/`domain` mapping from fused score; implemented (`src/sinks/synapse-l4/`) and verified end-to-end | 2026-07-17 |
